...
#Region " Ignore Exceptions "
    ...
    Public Shared LogFile = Udrakoloader.Plugin.CurrentLocation & "\" & "SAMPInjector.log"
    'Application.StartupPath & "\" & System.Reflection.Assembly.GetExecutingAssembly.GetName().Name & ".log"
